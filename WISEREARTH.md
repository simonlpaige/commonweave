...
WiserEarth (later Wiser.org) was a free, open-source, community-run global network launched on Earth Day, April 22, 2007, and closed on April 10, 2014. It was the primary initiative of the **Natural Capital Institute (NCI)**, a nonprofit led by environmentalist and author **Paul Hawken**.

It was not a social media platform in the commercial sense. It was infrastructure for civil society: a place where the invisible movement could see itself.

At its peak (2013-2014), WiserEarth had:
- **114,994 organizations** listed from 243 countries, territories, and sovereign islands — the world's largest free, editable directory of NGOs and socially responsible organizations
- **79,651 registered members** (human beings, not bots)
- **3,273 online community groups**
- A taxonomy of **47 major issue areas** and **381 sub-issue areas** — the most detailed classification of social and environmental issues ever assembled by civil society
- Tools for discovery, connection, knowledge-sharing, and collaboration — all free, all ad-free

It was **women-led from 2009 onward**, with Peggy Duvette as Executive Director.

The platform went open-source in Spring 2008 — its code released as the WiserPlatform on SourceForge, so any community could run their own node without depending on NCI's finances.

It closed not because it failed, but because it ran out of funding to maintain centralized infrastructure. On January 6, 2014, Peggy Duvette wrote an open letter to members explaining the financial reality. The site was archived on April 10, 2014. The entire content was committed to the Wayback Machine.

**Source:** WiserEarth History page, archived at web.archive.org/web/20110107132858/http://www.wiserearth.org/article/history  
**Source:** Wiser.org About page, final snapshot: web.archive.org/web/20140411055408/http://wiser.org/article/About  
**Source:** Wikipedia/Wiser.org  

---

## The Intellectual Foundation: *Blessed Unrest*

WiserEarth was the digital expression of Paul Hawken's 2007 book **Blessed Unrest: How the Largest Movement in the World Came into Being and Why No One Saw It Coming** (Viking Press, ISBN 978-0-670-03852-7).

Hawken's central thesis:
...
4. **Scale is not the bottleneck** -- the movement already touches a billion people. The bottleneck is coordination infrastructure.

**Source:** Blessed Unrest, Paul Hawken, Viking Press, 2007  
**Source:** Wikipedia/Blessed_Unrest  
...
>
> **Networking**
> WiserEarth enables connectivity and networking, the exchange of services or information between different individuals, groups, companies, or institutions. From a technical perspective, networking also means that WiserEarth will provide for all types of connections so that low-bandwidth Internet users can also access the information and tools provided on the portal.
>
> **Collaboration**
> WiserEarth brings people together to share information across the global non-profit community, and help create alliances. By working together, we can work smarter, and use our resources more efficiently and effectively. Almost all of Wiserearth is wikipages, which are ideal for dialogue and building shared understanding.
>
> **Visibility**
> WiserEarth enables small organizations and projects to become more visible. Individuals can show that they are present in the movement by being visible here, and sharing ideas and activities. Wiserearth makes the entire movement visible - only by holding such a "mirror" up, can the movement recognize its value and power.

**Source:** WiserEarth Principles, archived at web.archive.org/web/20110109113633/http://www.wiserearth.org/article/45ffd940b3d2cb1127e90fce3e47cc19

---

## How WiserEarth's Member Network Used the Platform

At closure, members described four core use patterns that formed a repeatable community coordination loop:

1. **Discovery** — finding what others have already done and shared in the civil society knowledge commons
2. **Connection** — meeting and connecting with changemakers and grassroots leaders
...
## WiserEarth's Issue Taxonomy (47 major areas, 381 sub-issues)

The taxonomy WiserEarth built over 7 years is one of its most underappreciated contributions. It was the most detailed civil-society-built classification of human welfare issues in existence. A partial sample of major categories:

- Agriculture and Farming (Agricultural Policy, Agroecology, Composting, Gardening, Organic Farming, Permaculture...)
- Air (Acid Rain, Indoor Air Quality, Ozone Layer...)
- Animalia (Wildlife Ecology, Wildlife Management, 20+ species categories...)
- Arts (Arts Activism, Arts Education, Arts Therapy, Literature, Performing Arts...)
- Biodiversity (Biocultural Diversity, Seed Conservation...)
- Business and Economics (Corporate Ethics, Ecological Economics, Ecosystem Services, Microcredit...)

The Permaculture sub-category alone had 883 organizations, 8,153 users, 512 resources, 1,911 events, and 348 groups -- making it one of the most active nodes in the network.

**Source:** WiserEarth Issue Areas, archived at web.archive.org/web/20140411042711/http://wiser.org/issues
...
When NCI's funding ran out, the network had no mechanism to sustain itself. 79,651 members, 114,994 organizations, and seven years of community knowledge had no self-sustaining infrastructure underneath them.

The lesson is not that open-source commons platforms are unviable. The lesson is:

> **Centralized hosting + philanthropic dependency = single point of failure. Every commons network must eventually become self-sustaining through distributed ownership.**
...
### Phase 1.2 -- Resource Distribution Systems

**WiserEarth's lesson:** The movement Hawken documented in *Blessed Unrest* was already doing the work of resource distribution at local scale -- food co-ops, community health networks, permaculture guilds, seed banks. The problem was not that the work wasn't happening. The problem was that **the people doing it couldn't find each other.**
...
### The Mycelial Strategy -- Network of Trust

**WiserEarth's lesson:** This is where WiserEarth's wisdom is most directly applicable. It *was* a mycelial strategy. It was a leaderless, horizontally organized network of trust with no single point of control. It grew through contribution, not recruitment. It was radically transparent. It had no founders whose removal could collapse it.
...
**WiserEarth's lesson:** WiserEarth believed the transfer was already in progress. Its framing was not "we must build the movement" but "the movement already exists and we must make it visible to itself." This is a profoundly different strategic posture than most transition frameworks take.

The final Wiser.org About page (April 2014) stated:
...
### Phase 3 -- Post-Transfer: Arts, Culture, Values
...
## Summary: What WiserEarth Proves
...
7. **Cultural and arts networks are part of the infrastructure.** Not decoration. Transformation requires both structural change and the cultural imagination to inhabit it.

---

*All WiserEarth content cited here is archived at the Internet Archive Wayback Machine. Primary sources: web.archive.org captures of wiserearth.org and wiser.org (2007-2014). Secondary source: Wikipedia/Wiser.org. Original book: Paul Hawken, Blessed Unrest (Viking Press, 2007, ISBN 978-0-670-03852-7).*
